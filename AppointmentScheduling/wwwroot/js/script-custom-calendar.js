        ...
        if (calendarEl != null)
        {
            var doctorId = $("#doctorId").val();
                ...
                events: function (fetchInfo, successCallback, failureCallback) {
                    $.ajax({
                        url: `${routeURL}/api/Appointment/GetCalendarData?doctorId=${doctorId}`,
                        type: 'GET',
                        dataType: 'JSON',
                            ...
                            if (response.status === 1) {
                                $.each(response.dataenum, function (i, data) {
                                    events.push({
                                        ...
                                        backgroundColor: data.isDoctorApproved ? "#28a745" : "#dc3534",
                                        borderColor: "#162466",
                                        textColor: "white",
                                        id: data.id
                                    });
...
function onSubmitForm() {
    ...
    //};
    var routes = `${routeURL}/api/Appointment/SaveCalendarData`;
    ...
    //$.ajax(payload).done(response => {
        //console.log("mess", response.message);
        //    if (response.status === 1 || response.status === 2) {
        //        $.notify(response.message, "success");
        //        onCloseModal();
        //    } else {
